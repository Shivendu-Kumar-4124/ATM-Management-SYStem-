...
connection = mysql.connect(host='localhost',user='root',password='tiger123',database='atm')
...
welcome_screen.iconbitmap(default="1.jpg") 
...
def withdraw_window():
        ...
        welcome_screen.bind("<Return>",withdraw_function)
def deposit_window():
        def destroy_all(): 
                window.place_forget() 
                dp_icon.destroy()
        ...
        welcome_screen.bind("<Return>",deposit_function)
...
def check_your_balance_window():
        ...
        welcome_screen.bind("<BackSpace>",destroy_all)
...
def change_your_pin_window():
        ...
        welcome_screen.bind("<Return>",proceed)
